            ...
            <div class="signin-signup">
                <form id="form-login" class="sign-in-form need-vali">
                    ...
                    <div class="input-field">
                        ...
                        <input id="form-login-input-username" type="text" placeholder="Username, Email atau NIK" />
                    </div>
                    <div class="input-field">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                <div class="content">
                    ...
                    <p>
                        <i>"Bayar SPP semudah satu, dua, tiga dengan Aplikasi Pembayaran SPP"</i>
                    </p>
                </div>
                <svg class="image" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500">
                    ...
                    <g id="freepik--Screen--inject-8">
                        ...
                        <path
                            ...
                            style="fill:#263238" />
                        <rect x="198.61" y="203.78" width="197.43" height="43.26" style="fill:#358EEF" />
                        <g style="opacity:0.8">
                            <rect x="198.61" y="203.78" width="197.43" height="43.26" style="fill:#fff" />
                        </g>
                        <rect x="211.31" y="217.3" width="16.21" height="16.21" rx="2.25"
                            style="fill:#358EEF" />
                        <path
                            ...
                            style="fill:#fff" />
                        <rect x="198.61" y="160.3" width="197.43" height="43.26" style="fill:#358EEF" />
                        <path
                            d="M394.85,203.72c0,.15-43.62.26-97.42.26s-97.42-.11-97.42-.26,43.61-.26,97.42-.26S394.85,203.58,394.85,203.72Z"
                            style="fill:#263238" />
                        <rect x="198.72" y="290.26" width="197.43" height="41.45" style="fill:#358EEF" />
                        <g style="opacity:0.8">
                            <rect x="198.72" y="290.26" width="197.43" height="41.45" style="fill:#fff" />
                        </g>
                        <rect x="211.41" y="303.79" width="16.21" height="16.21" rx="2.25"
                            style="fill:#358EEF" />
                        <path
                        ...
                        <rect x="211.31" y="173.82" width="16.21" height="16.21" rx="2.25"
                            style="fill:#358EEF" />
                        <path
                        ...
                        <path
                            ...
                            style="fill:#358EEF" />
                        <circle cx="99.19" cy="82.38" r="3.28" style="fill:#358EEF" />
                        <circle cx="108.31" cy="82.38" r="3.28" style="fill:#358EEF" />
                        <path d="M120.75,80.06a3.28,3.28,0,1,1-4.64,0A3.28,3.28,0,0,1,120.75,80.06Z"
                            style="fill:#358EEF" />
                        <path
                        ...
                        <path
                            ...
                            style="fill:#358EEF" />
                        <rect x="368.2" y="174.92" width="16.22" height="1" style="fill:#358EEF" />
                        <path
                        ...
                        <path
                            ...
                            style="fill:#358EEF" />
                        <rect x="368.2" y="215.91" width="16.22" height="1" style="fill:#358EEF" />
                        <path
                            d="M373.36,216.41h-1V215.3a2,2,0,0,1,2-2h4a2,2,0,0,1,2,2v.89h-1v-.89a1,1,0,0,0-1-1h-4a1,1,0,0,0-1,1Z"
                            style="fill:#358EEF" />
                        <path d="M374,227.8a35.61,35.61,0,0,1,0-8.59,35.61,35.61,0,0,1,0,8.59Z"
                            style="fill:#358EEF" />
                        <path d="M376.35,227.8a35.61,35.61,0,0,1,0-8.59,35.61,35.61,0,0,1,0,8.59Z"
                            style="fill:#358EEF" />
                        <path d="M378.72,227.8a35.61,35.61,0,0,1,0-8.59,35.61,35.61,0,0,1,0,8.59Z"
                            style="fill:#358EEF" />
                        <path
                            ...
                            style="fill:#358EEF" />
                        <rect x="368.2" y="306.03" width="16.22" height="1" style="fill:#358EEF" />
                        <path
                            d="M373.36,306.53h-1v-1.12a2,2,0,0,1,2-2h4a2,2,0,0,1,2,2v.9h-1v-.9a1,1,0,0,0-1-1h-4a1,1,0,0,0-1,1Z"
                            style="fill:#358EEF" />
                        <path d="M374,317.92a35.61,35.61,0,0,1,0-8.59,35.61,35.61,0,0,1,0,8.59Z"
                            style="fill:#358EEF" />
                        <path d="M376.35,317.92a35.61,35.61,0,0,1,0-8.59,35.61,35.61,0,0,1,0,8.59Z"
                            style="fill:#358EEF" />
                        <path d="M378.72,317.92a35.61,35.61,0,0,1,0-8.59,35.61,35.61,0,0,1,0,8.59Z"
                            style="fill:#358EEF" />
                        <path
                        ...
                        <polygon points="103.29 131.66 108.9 138.98 113.7 131.66 103.29 131.66"
                            style="fill:#263238" />
                    </g>
                    <g id="freepik--Character--inject-8">
                        ...
                        <path
                            ...
                            style="fill:#fafafa" />
                        <polygon points="143.22 315.76 167.72 359.82 140.54 368.17 143.22 315.76"
                            style="fill:#358EEF" />
                        <path
                        ...
                        <path
                            ...
                            style="fill:#eb996e" />
                        <path d="M60,311.61c-.49.33-18.09,5.59-20.86,23.63S38,384.7,38,384.7l47.74-3.28L72.05,318Z"
                            style="fill:#358EEF" />
                        <path
                        ...
                        <path
                            ...
                            style="fill:#263238" />
                        <path d="M118.61,294.83a41.85,41.85,0,0,1-22-6.28s5.15,11.41,21.66,10.16Z"
                            style="fill:#eb996e" />
                        <path
                    ...
                    <g id="freepik--Plant--inject-8">
                        ...
                        <path
                            ...
                            style="fill:#263238" />
                        <polygon points="451.64 408.96 446.09 445.41 423.89 445.37 416.42 408.96 451.64 408.96"
                            style="fill:#455a64" />
                        <path
