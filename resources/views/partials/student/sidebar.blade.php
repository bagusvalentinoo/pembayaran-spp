<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ route('web.student.dashboard.index') }}" class="app-brand-link">
            {{-- Logo --}}
    ...
    <ul class="menu-inner py-1">
        <!-- Dashboard -->
        <li class="menu-item {{ Route::currentRouteName() === 'web.student.dashboard.index' ? 'active' : '' }}">
            <a href="{{ route('web.student.dashboard.index') }}" class="menu-link">
